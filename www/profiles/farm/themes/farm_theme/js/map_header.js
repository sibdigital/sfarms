(function ($) {
  Drupal.behaviors.farm_theme_map = {
    attach: function(context, settings) {
      ...
      var link = '<div class="clearfix"><a href="#' + id + '" data-toggle="collapse" aria-expanded="' + (collapsed ? 'false' : 'true') + '" aria-controls="' + id + '" style="float: right; margin: 0.5em 1em 0 0;"><span class="glyphicon glyphicon-globe"></span>Скрыть карту</a></div>';
